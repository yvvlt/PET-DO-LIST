...
from config import ( # config.py에서 필요한 상수들을 가져옵니다.
    INITIAL_PET_NAME, INITIAL_PET_LEVEL, INITIAL_PET_EXP, 
    INITIAL_PET_HAPPINESS, INITIAL_PET_FULLNESS,
    PET_MAX_HAPPINESS, PET_MAX_FULLNESS,
    EXP_PER_TODO_COMPLETE, LEVEL_UP_EXP_REQUIREMENTS, DEFAULT_LEVEL_UP_EXP,
    PET_SPECIES_LIST
)
